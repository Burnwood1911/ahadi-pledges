                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group form-primary mb-3">
                                <input id="first_name" type="text" required class="form-control" name="first_name"
                                    placeholder="First Name">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group form-primary mb-3">
                                <input id="second_name" type="text" required class="form-control" name="second_name"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group form-primary mb-3 ">
                                <div class="input-group-prepend">
                                    <input id="phone" required type="text" class="form-control" name="phone"
                        ...
                        <div class="col-lg-6">
                            <div class="col form-group-form-primary">
                                ...
                                <div class="col ">
                                    <select name="card_id" id="card_id" class="form-control bg-gradient-light">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group form-primary mb-3">
                                <input id="date_of_birth" type="date" class="form-control" required name="date_of_birth"
                                    placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group form-primary mb-3"> <input id="password" type="password" required
